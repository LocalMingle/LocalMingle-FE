    ...
    <St.CardSection>
      <St.CardWrap>
        ...
        <St.CardBottom>
          ...
          >
            <path
              d="M22.8402 23.6793C20.5056 25.745 17.4102 26.9997 14.0002 26.9997C10.5901 26.9997 7.49476 25.745 5.16016 23.6793C5.29131 22.488 6.07826 21.3221 7.48164 20.4096C11.0753 18.1031 16.9512 18.1031 20.5187 20.4096C21.9221 21.3221 22.709 22.488 22.8402 23.6793Z"
              fill="#E7E7E7"
            />
            <path
            ...
            />
            <path
              d="M14.1715 16.5983C14.0717 16.584 13.9432 16.584 13.8291 16.5983C11.3179 16.5125 9.32031 14.4548 9.32031 11.9254C9.32031 9.33892 11.4035 7.23828 14.0003 7.23828C16.5829 7.23828 18.6803 9.33892 18.6803 11.9254C18.666 14.4548 16.6828 16.5125 14.1715 16.5983Z"
              fill="#E7E7E7"
            />
          </svg>
