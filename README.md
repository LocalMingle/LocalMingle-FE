...
<table>
  <tr>
    ...
    <td>
      ...
      더 효율적인 모듈 번들링 제공하기 때문에 빌드 시간이 매우 빠릅니다. 또한 타입스크립트를 지원하기 때문에 채택했습니다.
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      React 기반의 싱글 페이지 애플리케이션(SPA)에서 네비게이션을 간편하게 다룰 수 있다는 장점 때문에 채택했습니다.
    </td>
  </tr>
  <tr>
    <td><strong>React Query</strong></td>
    <td>
      간결하고 직관적인 API를 제공하여 코드를 더 쉽게 이해하고 유지보수할 수 있게 도와주며 데이터 관리를 효과적으로 처리할 수 있어 채택했습니다.
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      특히 중앙 집중화된 상태관리를 제공하여 전역 상태관리를 일관되게 관리할 수 있다는 장점이 있어 채택했습니다.
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      다국어 지원을 위한 인터내셔널라이제이션(i18n) 라이브러리로 다국어 기능 구현을 위해 사용했습니다.</br>
...
- 문제의 디테일
  <br>
로컬스토리지에 저장된 토큰값을 받아오지 못했다. 스토리지에 저장은 되어있는데 get이 되지않았습니다.
  <br>
- 해결을 위한 노력
  <br>
...
- 문제의 디테일
  <br>
다국어버튼을 통해서 언어가 변경되는걸 전역에 적용되도록 설정했는데, 변경버튼 클릭시마다 api를 불필요하게 매번 불러오는 현상이었습니다.
  <br>
- 해결을 위한 노력
  <br>
